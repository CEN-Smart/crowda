...
export default function HomePage() {
  return (
    <>
      <CustomHeading className='bg-white pt-[7.5rem] text-black' primaryHeading='Unleash the Power of Your Purpose: Crowdfund with Crowda!' description='The Blockchain Powered Crowdfunding Platform that Rewards Backers and Fuels Dreams' leftButton='Create a project' rightButton='Support a project' leftBtnBgColor='black' rightBtnTextColor='black' rightBtnClassName='hover:font-semibold'
