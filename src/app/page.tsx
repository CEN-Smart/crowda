...
export default function HomePage() {
  return (
    <>
      <CustomHeading className='bg-slate-800 pt-[7.5rem] text-white' primaryHeading='Unleash the Power of Your Purpose: Crowdfund with Crowda!' description='The Blockchain Powered Crowdfunding Platform that Rewards Backers and Fuels Dreams' leftButton='Create a project' rightButton='Support a project' leftBtnBgColor='black' rightBtnTextColor='white' rightBtnClassName='hover:font-semibold'
        leftBtnClassName='hover:font-semibold'
      />

      <Container className='bg-slate-800 pb-16'>
      ...
      <Container className='py-12 text-center bg-slate-800 text-zinc-300'>
        <CustomButton className='transition-all duration-300 font-bold text-gray-400 text-xl lg:text-2xl hover:text-white shadow-custom hover:bg-slate-800' big title='Explore More' textColor='white' border />
      </Container>
